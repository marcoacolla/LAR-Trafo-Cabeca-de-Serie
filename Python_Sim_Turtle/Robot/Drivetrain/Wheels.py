...
class Wheel:
    ...
    def setPosition(self, new_position):
        # As rodas acompanham visualmente a caixa, desenhando-se sempre relativas ao centro da tela (0,0), igual à caixa
        ...
        # Calcula a posição relativa à caixa (centro da tela)
        ...
        # Como a caixa está sempre em (0,0) na tela, as rodas também devem ser desenhadas relativas a (0,0)
        screen_pos = (rotated_x, rotated_y)
        self.turtle.goto(screen_pos)
